...
<script type="text/javascript">
    ...
    var setUsersList = function(searchKeyword) {
        ...
        for (var i = 0; i < listLength; i++) {
            ...
            // userId = demo1
            // caasAccountName = b3081ea3-6387-4d0f-9d03-26df8cd893e1-demo1-user

            if ((nvl(searchKeyword) === "") || userId.indexOf(searchKeyword) > -1) {

                // 1. caas_account_name : b3081ea3-6387-4d0f-9d03-26df8cd893e1-demo1-user
                userName = userId;
                ...
                splitWord = (SPACE_GUID + "-" + userName).toLowerCase() + "-";

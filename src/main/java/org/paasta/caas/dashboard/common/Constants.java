...
public class Constants {
    ...
    // COMMON API URI
    public static final String URI_COMMON_API_USERS_LIST = "/users/serviceInstanceId/{serviceInstanceId:.+}/spaceGuid/{spaceGuid:.+}";
    public static final String URI_COMMON_API_USERS_DETAIL = "/users/serviceInstanceId/{serviceInstanceId:.+}/spaceGuid/{spaceGuid:.+}/userId/{userId:.+}/";

...
public class UsersService {
     ...
     */
    UsersList getUsesListByServiceInstanceId(String serviceInstanceId, String spaceGuid) {
        return restTemplateService.send(Constants.TARGET_COMMON_API, Constants.URI_COMMON_API_USERS_LIST
                ...
                .replace("{spaceGuid:.+}", spaceGuid), HttpMethod.GET, null, UsersList.class);
    }
     ...
     * @return the user
     */
    Users getUserByServiceInstanceId(String serviceInstanceId, String spaceGuid, String userId) {
        Users users = restTemplateService.send(Constants.TARGET_COMMON_API, Constants.URI_COMMON_API_USERS_DETAIL
                .replace("{serviceInstanceId:.+}", serviceInstanceId)
                .replace("{spaceGuid:.+}", spaceGuid)
     ...
     * @return the user
     */
    Users updateUserRole(String serviceInstanceId, String spaceGuid, Users user) {
    ...
    Users deleteUserByServiceInstanceId(Users user) {
        ...
        return restTemplateService.send(Constants.TARGET_COMMON_API, Constants.URI_COMMON_API_USERS_DETAIL
                ...
                .replace("{spaceGuid:.+}", user.getSpaceGuid())
